...
const usernameMail = process.env.usernameMail;
const passwordMail = process.env.passwordMail;

//who do we notify
const emailNotify = process.env.emailNotify;

//edge desktop browser user agent string
const userAgentDesktop = process.env.userAgentDesktop;

//chrome mobile browser user agent string
const userAgentMobile = process.env.userAgentMobile;

//we will check our points when browsing our desktop app
const pointsContainerDesktop = process.env.pointsContainerDesktop;

//how many searches do we perform
const searchLimitDesktop = parseInt(process.env.searchLimitDesktop);
const searchLimitMobile = parseInt(process.env.searchLimitMobile);

//where do we start
const urlHomePage = process.env.urlHomePage;

//our search url
const urlSearch = process.env.urlSearch;

//page containing our reward urls to earn bonus points
const urlRewards = process.env.urlRewards;

//how long to wait between actions
const wait = parseInt(process.env.wait);

//how long do we wait for a web page to load
const loadWebPageTimeout = parseInt(process.env.loadWebPageTimeout);
...
const wordSearchTotal = parseInt(process.env.wordSearchTotal);

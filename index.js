...
//chrome desktop browser user agent string
//const userAgentDesktop = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36';
	...
	try {
		...
		if (mobile) {
			...
			try {
				...
				await page.click('.b_toggle');
				
			} catch (error) {
				
				//sometimes the object is not there and we don't want the app to crash
				console.log(error);
				console.log('that\'s ok we can still continue');
			}
